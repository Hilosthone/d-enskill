...
//     href: '/admin/scholarships/cohorts',
//     icon: Layers,
//   },
//   {
//     label: 'Scholarship manual onboard',
//     href: '/admin/scholarships/manual-onboard',
//     icon: UserPlus,
//   },
...
// Extended navigation items list including Question Banks, Questions, and Leaderboard
const adminNavItems = [
  { label: 'Dashboard', href: '/admin/dashboard', icon: LayoutDashboard },
  { label: 'Students', href: '/admin/students', icon: Users },
  { label: 'Manual Onboard', href: '/admin/manual-onboard', icon: UserPlus },
