...
export default function Scholarship() {
  return (
    <section
      id='scholarship'
      className='py-24 px-6 bg-primary-blue text-white text-center'
    >
      <div className='max-w-3xl mx-auto' data-aos='zoom-in'>
        ...
        <Link
          href='/scholarship'
          className='inline-block bg-white text-primary-blue px-8 py-3 rounded-full font-bold hover:bg-gray-100 transition-colors'
        >
