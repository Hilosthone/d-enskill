...
//       }
//     } catch (err: any) {
//       // Fallback to local storage if backend throws a 500 server error
...
//         }, 4000)
//       } else {
//         // Fallback local append if backend returns custom object without throwing
//         const newAnnouncement: Announcement = {
//           id: Date.now(),
//           title,
//           content: message,
...
//       }
//     } catch (err: any) {
//       // Graceful local optimistic update when backend returns 500 error
//       const newAnnouncement: Announcement = {
//         id: Date.now(),
//         title,
//         content: message,
...
//             No active announcements found. Create one above to broadcast your first notice.
//           </div>
//         ) : (
