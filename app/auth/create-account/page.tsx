...
export default function CreateAccountPage() {
  ...
  const handleCreateAccount = async (e: React.FormEvent) => {
    ...
    try {
      // 1. Call backend setPassword endpoint with correct payload structure
      ...
      <div className='max-w-md w-full bg-white dark:bg-gray-900 p-8 rounded-2xl border border-gray-200 dark:border-gray-800 shadow-sm space-y-6'>
        ...
        <form onSubmit={handleCreateAccount} className='space-y-4'>
          ...
          <button
            ...
            className='w-full bg-primary-purple text-white py-4 rounded-xl font-bold hover:opacity-95 transition-all shadow-lg shadow-primary-purple/20 cursor-pointer disabled:opacity-60'
          >
            {isSubmitting
